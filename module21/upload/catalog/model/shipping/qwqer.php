                ...
                foreach ($prices as $key=>$price){
                    ...
                    if ($key_r == 'omnivaparcelterminal' && $this->request->get['route'] != 'api/shipping/methods'){
                        ...
                        if (isset($terminals['data']["omniva"]) && $terminals['data']["omniva"] ){
                            ...
                            $template   = $this->load->view('default/template/extension/shipping/qwqer.tpl', array(
                            ...
                            $template   = $this->load->view('default/template/extension/shipping/qwqer.tpl', array('text_title_order_type'=> $var));
                        }
                    }else{
                        $template   = $this->load->view('default/template/extension/shipping/qwqer.tpl', array('text_title_order_type'=> $var));
                    }
