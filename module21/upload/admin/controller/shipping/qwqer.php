...
class ControllerShippingQwqer extends Controller {//
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('shipping/qwqer', 'token=' . $this->session->data['token'] . '&type=shipping'.'&tab='.$tab, true));
		}
		...
		$this->response->setOutput($this->load->view('extension/shipping/qwqer.tpl', $data));
	}
