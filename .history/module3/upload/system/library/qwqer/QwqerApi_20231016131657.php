...
class QwqerApi {
    ...
    private  $createOrderUrl    = '/clients/auth/trading-points/{trading_points}/delivery-orders/get-price';
    ...
    public function generateOrderObjects($address, $delivery_objects=array()){
        ...
        //Store data
        $store_phone = $this->registry->get('config')->get('config_telephone');
        ...
        if (isset($this->registry->get('session')->data["guest"]["telephone"])){
