...
find ./build/static/js -name main.*.js -exec cp {}  /hdd/user/PhpstormProjects/docker-compose-lamp/www/oc21/catalog/view/javascript/qwqer/shipping_qwqer.js \;
...
find ./build/static/js -name main.*.js -exec cp {}  /hdd/user/PhpstormProjects/docker-compose-lamp/www/oc38/catalog/view/javascript/qwqer/shipping_qwqer.js \;
